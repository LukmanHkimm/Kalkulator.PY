...
for j in range(2,5):
    for k in range(3):
        btn.append(Button(calc, width=6, height=2,font=('arial',20,'bold'), bd =4, bg="White", text =numberpad[i]))
...
btnMult = Button(calc, text="X", width=6, height=2,font=('arial',20,'bold'), bd =4,bg="powder blue",
...
btnPi = Button(calc, text="∏", width=6, height=2,font=('arial',20,'bold'), bd =4,bg="powder blue",
...
btn2Pi = Button(calc, text="2∏", width=6, height=2,font=('arial',20,'bold'), bd =4,bg="powder blue",
...
btn1gamma = Button(calc, text="Lgamma", width=6, height=2,font=('arial',20,'bold'), bd =4,bg="powder blue",
...
def iExit():
    iExit = tkinter.messagebox.askyesno("Kalkulator Ilmia","Klik Yes jika ingin keluar")
    if iExit > 0:
        root.destroy()
        return
...
filemenu.add_command(label = "Keluar", command = iExit)
